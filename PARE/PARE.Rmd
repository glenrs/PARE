...
#### TODO #####
Study this carefully: http://www.fharrell.com/2017/03/damage-caused-by-classification.html
And these: https://twitter.com/RogueRad/status/940368577290481665 and 
AUROC seems to be problematic when there are only a few prediction values (e.g., predictions are either 0.0, 0.5, or 1.0 or something like that). Scores are lower than they should be.
